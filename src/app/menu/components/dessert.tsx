...
import dessertpic from "@/public/dessertpic.png"
                ...
                <div className="flex justify-around">
                    <div>
                        <div className="mt-2">
                            ...
                            <h1 className="text-3xl font-sans font-bold">Dessert</h1>
                        </div>
                        <div className="flex border-b border-slate-500 mt-3">
                            <div>
                                <h2 className="font-semibold text-[17px] w-[230px] hover:text-[#FF9F0D]">Fig and lemon cake</h2>
                        ...
                        <div className="flex border-b border-slate-500 mt-3">
                            <div>
                                <h2 className="font-semibold text-[17px] w-[230px] hover:text-[#FF9F0D]">Creamy mascarpone cake</h2>
                        ...
                        <div className="flex border-b border-slate-500 mt-3">
                            <div>
                                <h2 className="font-semibold text-[17px] w-[230px] hover:text-[#FF9F0D]">Pastry, blueberries, lemon juice</h2>
                        ...
                        <div className="flex border-b border-slate-500 mt-3">
                            <div>
                                <h2 className="font-semibold text-[17px] w-[230px] hover:text-[#FF9F0D]">Pain au chocolat</h2>
